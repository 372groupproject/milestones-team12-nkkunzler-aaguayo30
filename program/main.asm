...
_move_enemy:
	...
	MOV		rdi, r9
	MOV		rsi, 0			; Move up/dowm 0 row
	MOV		rdx, 1			; move left/right 1 columns
	CALL	_valid_move	
	MOV		r13, rax

	;check if we can move down
	MOV		rdi, r9
	MOV		rsi, 1			; Move down 1 row
	MOV		rdx, 0			; move left/right 0 column
	CALL	_valid_move	
	MOV		r14, rax
...
.right_set_neg:
	MOV		r13, 1000000			; set distance = BIG NUMBER
	JMP		.down_check
...
.compare_right:
	...
	JLE		.up_min			; distance moving up is closer
